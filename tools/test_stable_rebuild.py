...
class StableRebuildTests(unittest.TestCase):
    def test_current_corpus_counts_and_bootstrap_invariant(self):
        ...
        self.assertEqual(report['canonical']['chinese_commentary_segments'],128)
        self.assertEqual(report['canonical']['claims'],329)
        self.assertEqual(report['canonical']['event_fixtures'],329)
