...
from build_handoff_corpus import CAPABILITIES, claim_type, dump, dump_jsonl, probe_media, relevant_capabilities, sec, split_assertions
...
def main() -> None:
    ...
    out=root/'data/evaluation/replay_seeds/handoff_v4'; eligible=[r for r in seed.get('records',[]) if r.get('seed_eligibility')=='eligible-seed']; by_id={r['seed_id']:r for r in eligible}
